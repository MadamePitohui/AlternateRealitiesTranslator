    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            ...
            path: ExternalSourcesWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'ExternalSources')
                : NavBarPage(
                    initialPage: 'ExternalSources',
                    page: ExternalSourcesWidget(),
                  )),
        FFRoute(
            name: TextToSignWidget.routeName,
            path: TextToSignWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: TextToSignWidget(),
                )),
        FFRoute(
          name: SignDictionaryWidget.routeName,
          path: SignDictionaryWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'SignDictionary')
              : SignDictionaryWidget(),
        ),
        FFRoute(
            name: LessonBuffetWidget.routeName,
            path: LessonBuffetWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'LessonBuffet')
                : NavBarPage(
                    initialPage: 'LessonBuffet',
        ...
        FFRoute(
          name: ASLalphabetDemoWidget.routeName,
          path: ASLalphabetDemoWidget.routePath,
          builder: (context, params) => ASLalphabetDemoWidget(),
        ),
        FFRoute(
          name: ASLalphabetDemoYesWidget.routeName,
          path: ASLalphabetDemoYesWidget.routePath,
          builder: (context, params) => ASLalphabetDemoYesWidget(),
        ),
        FFRoute(
