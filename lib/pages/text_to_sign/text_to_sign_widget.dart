...
class TextToSignWidget extends StatefulWidget {
  const TextToSignWidget({super.key});

  static String routeName = 'TextToSign';
  static String routePath = '/textToSign';

  @override
  State<TextToSignWidget> createState() => _TextToSignWidgetState();
}
...
class _TextToSignWidgetState extends State<TextToSignWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'TextToSign'});
