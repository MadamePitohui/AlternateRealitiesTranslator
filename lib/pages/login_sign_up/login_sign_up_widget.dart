...
class _LoginSignUpWidgetState extends State<LoginSignUpWidget>
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xB010032E),
        body: SafeArea(
          top: true,
          child: Align(
                    ...
                    children: [
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: Text(
                            'Alternate Reality Translator [ART]',
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  suffixIcon: _model
                                                                      ...
                                                                      ? InkWell(
                                                                          onTap:
                                                                              () async {
                                                                            _model.signupEmailAddressTextController?.clear();
                                                                            safeSetState(() {});
                                                                          },
                                                                          child:
                                                                              Icon(
                                    ...
                                    children: [
                                      if (_model.tabBarCurrentIndex == 1)
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'LOGIN_SIGN_UP_PAGE_Login_Button_ON_TAP');
                                            logFirebaseEvent(
                                                'Login_Button_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
