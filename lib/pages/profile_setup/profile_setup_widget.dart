...
class _ProfileSetupWidgetState extends State<ProfileSetupWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF6F4EBC),
        appBar: AppBar(
          backgroundColor: Color(0xFF6F4EBC),
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('PROFILE_SETUP_arrow_back_rounded_ICN_ON_');
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PROFILE_SETUP_Column_adkve9b0_ON_TAP');
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return TextFormField(
                                                  ...
                                                  onFieldSubmitted: (_) async {
                                                    logFirebaseEvent(
                                                        'PROFILE_SETUP_DisplayName_ON_TEXTFIELD_S');
                                                    logFirebaseEvent(
                                                        'DisplayName_backend_call');
                                          ...
                                          children: [
                                            ...
                                            StreamBuilder<List<UsersRecord>>(
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<UsersRecord>
                                                    languageUsersRecordList =
                                                    snapshot.data!;
                                                // Return an empty Container when the item does not exist.
                                                if (snapshot.data!.isEmpty) {
                                                  return Container();
                                                }
                                                final languageUsersRecord =
                                                    languageUsersRecordList
                                                            .isNotEmpty
                                                        ? languageUsersRecordList
                                                            .first
                                                ...
                                                return FlutterFlowDropDown<
                                                  ...
                                                  onChanged: (val) async {
                                                    safeSetState(() => _model
                                                        .languageValue = val);
                                                    logFirebaseEvent(
                                                        'PROFILE_SETUP_Language_ON_FORM_WIDGET_SE');
                                                    logFirebaseEvent(
                                                        'Language_backend_call');
                        ...
                        Padding(
                          ...
                          child: Container(
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'PROFILE_SETUP_SAVE_PROFILE_BTN_ON_TAP');
