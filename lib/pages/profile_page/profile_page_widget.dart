                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'PROFILE_PAGE_PAGE_Icon_msagraoq_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon_navigate_to');
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (selectedMedia !=
                                                                        ...
                                                                        selectedMedia.every((m) => validateFileFormat(
                                                                            ...
                                                                            context))) {
                                                                      safeSetState(() =>
                                                                          _model.isDataUploading_uploadDataU6t =
                                                                              true);
                                                                      ...
                                                                      if (selectedUploadedFiles.length ==
                                                                        ...
                                                                        safeSetState(
                                                                            () {
                                                                          _model.uploadedLocalFile_uploadDataU6t =
                                                                              selectedUploadedFiles.first;
                                                                          _model.uploadedFileUrl_uploadDataU6t =
                                                                              downloadUrls.first;
                                                                        });
                                                                      } else {
                                                                        safeSetState(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.bioTextController ??=
                                ...
                                text: profilePageUsersRecord?.bio,
                              ),
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                () async {
                                  logFirebaseEvent(
                                      'PROFILE_Bio_ON_TEXTFIELD_CHANGE');
                                  logFirebaseEvent('Bio_update_page_state');
                                  _model.bioText =
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                context.goNamedAuth(LoginSignUpWidget.routeName,
                                    context.mounted);
                              },
                              text: 'Log Out',
