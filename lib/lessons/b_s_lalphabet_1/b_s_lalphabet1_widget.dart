...
import 'b_s_lalphabet1_model.dart';
export 'b_s_lalphabet1_model.dart';

class BSLalphabet1Widget extends StatefulWidget {
  const BSLalphabet1Widget({
    super.key,
  ...
  static String routeName = 'BSLalphabet-1';
  static String routePath = '/bSLalphabet1';

  @override
  State<BSLalphabet1Widget> createState() => _BSLalphabet1WidgetState();
}

class _BSLalphabet1WidgetState extends State<BSLalphabet1Widget> {
  late BSLalphabet1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BSLalphabet1Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'BSLalphabet-1'});
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'B_S_LALPHABET_1_PAGE_exitLesson_ON_TAP');
                        ...
                        if (_model.correct)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'B_S_LALPHABET_1_PAGE_nextQuiz_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_1_PAGE_Z_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_1_PAGE_Correct_ON_TAP');
                                  if (_model.answered) {
                                    logFirebaseEvent(
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_1_PAGE_F_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_1_PAGE_Q_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
