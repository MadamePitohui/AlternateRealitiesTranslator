...
import 'a_s_lalphabet2_model.dart';
export 'a_s_lalphabet2_model.dart';

class ASLalphabet2Widget extends StatefulWidget {
  const ASLalphabet2Widget({
    super.key,
  ...
  static String routeName = 'ASLalphabet-2';
  static String routePath = '/aSLalphabet2';

  @override
  State<ASLalphabet2Widget> createState() => _ASLalphabet2WidgetState();
}

class _ASLalphabet2WidgetState extends State<ASLalphabet2Widget> {
  late ASLalphabet2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ASLalphabet2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ASLalphabet-2'});
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'A_S_LALPHABET_2_PAGE_exitLesson_ON_TAP');
                        ...
                        if (_model.correct)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'A_S_LALPHABET_2_PAGE_nextQuiz_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_2_PAGE_Z_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_2_PAGE_F_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_2_PAGE_Correct_ON_TAP');
                                  if (_model.answered) {
                                    logFirebaseEvent(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_2_PAGE_Q_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
