...
import 'a_s_lalphabet3_model.dart';
export 'a_s_lalphabet3_model.dart';

class ASLalphabet3Widget extends StatefulWidget {
  const ASLalphabet3Widget({
    super.key,
  ...
  static String routeName = 'ASLalphabet-3';
  static String routePath = '/aSLalphabet3';

  @override
  State<ASLalphabet3Widget> createState() => _ASLalphabet3WidgetState();
}

class _ASLalphabet3WidgetState extends State<ASLalphabet3Widget> {
  late ASLalphabet3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ASLalphabet3Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ASLalphabet-3'});
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'A_S_LALPHABET_3_PAGE_exitLesson_ON_TAP');
                        ...
                        if (_model.correct)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'A_S_LALPHABET_3_PAGE_nextQuiz_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_3_PAGE_Z_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_3_PAGE_F_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_3_PAGE_Q_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_3_PAGE_Correct_ON_TAP');
                                  if (_model.answered) {
                                    logFirebaseEvent(
