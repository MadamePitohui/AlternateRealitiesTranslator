...
import 'a_s_lalphabet1_model.dart';
export 'a_s_lalphabet1_model.dart';

class ASLalphabet1Widget extends StatefulWidget {
  const ASLalphabet1Widget({
    super.key,
  ...
  static String routeName = 'ASLalphabet-1';
  static String routePath = '/aSLalphabet1';

  @override
  State<ASLalphabet1Widget> createState() => _ASLalphabet1WidgetState();
}

class _ASLalphabet1WidgetState extends State<ASLalphabet1Widget> {
  late ASLalphabet1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ASLalphabet1Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ASLalphabet-1'});
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'A_S_LALPHABET_1_PAGE_exitLesson_ON_TAP');
                        ...
                        if (_model.correct)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'A_S_LALPHABET_1_PAGE_nextQuiz_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_1_PAGE_Z_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_1_PAGE_Correct_ON_TAP');
                                  if (_model.answered) {
                                    logFirebaseEvent(
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_1_PAGE_F_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'A_S_LALPHABET_1_PAGE_Q_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
