...
import 'b_s_lalphabet_model.dart';
export 'b_s_lalphabet_model.dart';

class BSLalphabetWidget extends StatefulWidget {
  const BSLalphabetWidget({
    super.key,
  ...
  static String routeName = 'BSLalphabet';
  static String routePath = '/bSLalphabet';

  @override
  State<BSLalphabetWidget> createState() => _BSLalphabetWidgetState();
}

class _BSLalphabetWidgetState extends State<BSLalphabetWidget> {
  late BSLalphabetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BSLalphabetModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'BSLalphabet'});
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'B_S_LALPHABET_PAGE_exitLesson_ON_TAP');
                        ...
                        if (_model.correct)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'B_S_LALPHABET_PAGE_nextQuiz_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_PAGE_Correct_ON_TAP');
                                  if (_model.answered) {
                                    logFirebaseEvent(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_PAGE_Z_BTN_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_PAGE_F_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_PAGE_Q_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
