...
import 'b_s_lalphabet3_model.dart';
export 'b_s_lalphabet3_model.dart';

class BSLalphabet3Widget extends StatefulWidget {
  const BSLalphabet3Widget({
    super.key,
  ...
  static String routeName = 'BSLalphabet-3';
  static String routePath = '/bSLalphabet3';

  @override
  State<BSLalphabet3Widget> createState() => _BSLalphabet3WidgetState();
}

class _BSLalphabet3WidgetState extends State<BSLalphabet3Widget> {
  late BSLalphabet3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BSLalphabet3Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'BSLalphabet-3'});
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'B_S_LALPHABET_3_PAGE_exitLesson_ON_TAP');
                        ...
                        if (_model.correct)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'B_S_LALPHABET_3_PAGE_nextQuiz_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_3_PAGE_Z_BTN_ON_TAP');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_3_PAGE_F_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                          ...
                          Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_3_PAGE_Q_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_page_state');
                                  _model.answered = true;
                                  safeSetState(() {});
                                },
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'B_S_LALPHABET_3_PAGE_Correct_ON_TAP');
                                  if (_model.answered) {
                                    logFirebaseEvent(
